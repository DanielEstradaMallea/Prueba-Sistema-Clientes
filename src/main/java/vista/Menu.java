...
public class Menu extends MenuPlantilla {
	...
	public void AgregarCliente() {
		...
		Cliente cli = new Cliente(run, nombres, apellidos, antiguedad, CategoriaEnum.Activo);
	...
	public void exportarDatos() {
		...
		do {
			...
			switch (opcionExp) {
			case 1:
				System.out.println("Ingresa la ruta en donde desea exportar el archivo ProductosImportados.csv (por defecto src)");
				ruta = sc.next();
				...
				break;
			case 2:
				System.out.println("Ingresa la ruta en donde desea exportar el archivo ProductosImportados.txt (por defecto src)");
				ruta = sc.next();
